function library()
    ...
    function internal:new(bp)
        ...
        -- Class Functions.
        function self:weaponskill(weapon)
            return weapon and aftermaths[weapon] or false            
        end
    
        function self:id(level)
        ...
        function self:checkRelic()
            ...
            if bp and bp.helpers['equipment'] ~= nil then
                ...
                for _,v in ipairs(relics) do
                    ...
                    if bp.helpers['equipment'].main and bp.helpers['equipment'].main.en == v then -- NEEDS FIX.
                        return true
                    end
