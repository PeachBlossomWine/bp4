...
function library:new(bp)
    ...
    -- Public Methods.
    self.connected = function() return flags.__connected and flags.__connected == 1 and true or false end

    self.connect = function(connection, callback)
    ...
    self.send = function(direction, id, data)
